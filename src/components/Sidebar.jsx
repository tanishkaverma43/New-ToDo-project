...
import { Grid3x3, Users, ChevronsLeft } from "lucide-react";
...
const Sidebar = () => {
  ...
  return (
    <div className="w-[280px] z-50 bg-white h-full flex border-r border-gray-200 font-inter flex-col items-start px-6 py-6">
      ...
      <div className="flex flex-col justify-start text-gray-600 cursor-pointer items-start gap-5 font-normal w-full">
      ...
      <div className="w-full mt-4">
        ...
        <div className="relative w-full flex flex-col mt-8 justify-center items-center">
          <div className="absolute -top-6 flex justify-center items-center z-10 bg-white w-12 h-12 rounded-full border-2 border-purple-100">
            <IoBulbOutline size={24} className="text-yellow-400" />
          </div>
          <div className="w-full rounded-2xl flex flex-col p-5 pt-10 justify-center text-sm items-center bg-purple-50 gap-3">
            ...
            <button className="bg-gray-700 hover:bg-gray-800 px-4 py-2 text-white w-full rounded-lg text-sm mt-1 transition-colors font-medium">
              Write a message
            </button>
          </div>
        </div>
